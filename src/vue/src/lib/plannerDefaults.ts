...
// (the options object) and the Quality enum (qualityLevels). This is the only
// production module that knows its shape; everything else in the app imports from here.
// plannerDefaults.test.ts is a deliberate exception - it imports the JSON artifact
// directly so its assertions are not tautological against this module's own re-exports.
//
...
export const QUALITY_LEVELS = artifact.qualityLevels
