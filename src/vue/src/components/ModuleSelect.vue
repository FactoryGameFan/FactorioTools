<template>
  <CustomizeSelect
    :defaultIsCustom="isCustom"
    @update:isCustom="(newVal: boolean) => $emit('update:isCustom', newVal)"
    customLabel="Module"
    :label="label"
  ...
  >
    ...
    <option v-if="showProductivityModules" value="productivity-module-3">
      Productivity module 3
    </option>
    <option value="speed-module">Speed module</option>
    <option value="speed-module-2">Speed module 2</option>
    <option value="speed-module-3">Speed module 3</option>
  </CustomizeSelect>
</template>
